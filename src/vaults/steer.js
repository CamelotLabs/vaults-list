...
const strategyTemplates = {
  MVCS: (symbol, vaultAddress, overrides) => ({
  ...
  CRSV: (symbol, vaultAddress, overrides) => ({
    ...baseStrategy(vaultAddress, overrides),
    strategy: "CRSV",
  ...
  GSSS: (symbol, vaultAddress, overrides) => ({
    ...baseStrategy(vaultAddress, overrides),
    strategy: "GSSS",
  ...
  HLCS: (symbol, vaultAddress, overrides) => ({
    ...baseStrategy(vaultAddress, overrides),
    strategy: "HLCS",
  ...
  EES: (symbol, vaultAddress, overrides) => ({
    ...baseStrategy(vaultAddress, overrides),
    strategy: "EES",
  ...
  MSS: (symbol, vaultAddress, overrides) => ({
    ...baseStrategy(vaultAddress, overrides),
    strategy: "MSS",
  ...
  HLCSV: (symbol, vaultAddress, overrides) => ({
    ...baseStrategy(vaultAddress, overrides),
    strategy: "HLCSV",
    fullname: `Steer High Low Channel V2 ${symbol}`,
    description: "The High Low Channel Strategy is a sophisticated LP approach that utilizes the Donchian channel as its foundation. By considering the highest high and the lowest low over a designated period, this strategy forms a robust price channel. An optional multiplier can be applied to widen the channel, offering more flexibility and potential to capitalize on larger price movements. With this strategy, LPs can dynamically adapt to market volatility and position themselves advantageously within the evolving price landscape."
  }),
  SSSV: (symbol, vaultAddress, overrides) => ({
    ...baseStrategy(vaultAddress, overrides),
    strategy: "SSSV",
  ...
  chains: [{
    ...
    strategies: [
      createStrategy({
        strategy: "MVCS",
        symbol: "ARB-USDC",
        vaultAddress: "0x11290316a4dc61C89c0Fa082Dd272744f656fb49",
        poolAddress: "0xfaE2AE0a9f87FD35b5b0E24B47BAC796A7EEfEa1"
      }),
      createStrategy({
        strategy: "CRSV",
        symbol: "ARB-USDC",
        vaultAddress: "0x127e3Ee25DfD74D2e03559bb29356eAF3186c931",
        poolAddress: "0xfaE2AE0a9f87FD35b5b0E24B47BAC796A7EEfEa1"
      }),
      createStrategy({
        strategy: "GSSS",
        symbol: "WBTC-svBTC",
        vaultAddress: "0x19bDb97b8e57534eFE410A3bB8E73C980F4c30bF",
      ...
      createStrategy({
        strategy: "HLCS",
        symbol: "WINR-USDC",
        vaultAddress: "0x1Ac72fDdf41397FdA7845b03199DF62e113D8D44",
        poolAddress: "0xc35AA1cEc34E02A8acc3E5f79c22BE364823094c"
      }),
      createStrategy({
        strategy: "EES",
        symbol: "ETH-LINK",
        vaultAddress: "0x1dF9A6Cb4f0148e7041aAfabf102Dd12BC5E8F3a",
        poolAddress: "0xe8795cF9c2309eCfe05Df028eB0F21D5D6e3a951"
      }),
      createStrategy({
        strategy: "GSSS",
        symbol: "LUSD-USDC",
        vaultAddress: "0x33500181093086c26F581E9D835f5B6CE829Cc26",
        poolAddress: "0x3d7412e255c04239285cAd57f82220D07D6874B0"
      }),
      createStrategy({
        strategy: "MSS",
        symbol: "USDC-MIM",
        vaultAddress: "0x38B44bB001456091bfac7b0E3eBeaBfC7DA6E626",
        poolAddress: "0x0e7AC13617Cc1A289B222E4602BdAaA53ea4dc61"
      }),
      createStrategy({
        strategy: "CRSV",
        symbol: "DPX-ETH",
        vaultAddress: "0x3d30d2a197a7F4738cED55d269c5C37F267bb136",
      ...
      createStrategy({
        strategy: "GSSS",
        symbol: "USDC-DAI",
        vaultAddress: "0x5f033d4d786eC5592FDbb5B289000A2B9A466D32",
        poolAddress: "0x45FaE8D0D2acE73544baab452f9020925AfCCC75"
      }),
      createStrategy({
        strategy: "EES",
        symbol: "ETH-USDC",
        vaultAddress: "0x801B4184de0CDF298ce933b042911500FADA1de6",
        poolAddress: "0xB1026b8e7276e7AC75410F1fcbbe21796e8f7526"
      }),
      createStrategy({
        strategy: "EES",
        symbol: "ETH-GMX",
        vaultAddress: "0x843a07b949820eaA8362d52d4b600f367C6D7312",
        poolAddress: "0xC99be44383BC8d82357F5A1D9ae9976EE9d75bee"
      }),
      createStrategy({
        strategy: "HLCS",
        symbol: "RDNT-ETH",
        vaultAddress: "0x974c148d09d6E6d00A7aB4680DbDaF7bEAAf2be5",
        poolAddress: "0xD51F7383C906cfD995d7f24729F37933Ff264Fa6"
      }),
      createStrategy({
        strategy: "CRSV",
        symbol: "stEUR-wstETH",
        vaultAddress: "0x97c7605AF1cf301D440EB9Aff359C4d80Fe1d430",
        poolAddress: "0x6C41A770583Fc7141FBeA9ac741f9015A4De6FDa"
      }),
      createStrategy({
        strategy: "HLCS",
        symbol: "GRAIL-USDC",
        vaultAddress: "0x980694538542CdB70C2F791f6d406a5E89EE6FaA",
        poolAddress: "0x8cc8093218bCaC8B1896A1EED4D925F6F6aB289F"
      }),
      createStrategy({
        strategy: "HLCSV",
        symbol: "VELA-ETH",
        vaultAddress: "0x9ad0e71AaD6deBEAB4f6131Bb75D53ACf74f8ed4",
      ...
      createStrategy({
        strategy: "MVCS",
        symbol: "ETH-GMX",
        vaultAddress: "0xb8732Ed168102E48A18C56745bb1c8d05d5b0a27",
        poolAddress: "0xC99be44383BC8d82357F5A1D9ae9976EE9d75bee"
      }),
      createStrategy({
        strategy: "CRSV",
        symbol: "ETH-USDT",
        vaultAddress: "0xC9296F25E907943E50a98e12a05c4672901d7bC2",
        poolAddress: "0x7CcCBA38E2D959fe135e79AEBB57CCb27B128358"
      }),
      createStrategy({
        strategy: "EES",
        symbol: "ETH-USDT",
        vaultAddress: "0xcF3BB5741fa421CbD961F4BD4E921b1D7BCF1Cb1",
        poolAddress: "0x7CcCBA38E2D959fe135e79AEBB57CCb27B128358"
      }),
      createStrategy({
        strategy: "HLCS",
        symbol: "WBTC-ETH",
        vaultAddress: "0xdA0E522FdA5245fA5AF9274790E8A519b6F25023",
        poolAddress: "0xd845f7D4f4DeB9Ff5bCf09D140Ef13718F6f6C71"
      }),
      createStrategy({
        strategy: "GSSS",
        symbol: "USDC-USDC",
        vaultAddress: "0xE5a04695c017558e071494Cc547ab4c3fc990DBa",
        poolAddress: "0xc86Eb7B85807020b4548EE05B54bfC956eEbbfCD"
      }),
      createStrategy({
        strategy: "CRSV",
        symbol: "GRAIL-ETH",
        vaultAddress: "0xEf8CbDEe27cC9fe2fC7EC2bBc840BECbf83f0c3c",
        poolAddress: "0x60451B6aC55E3C5F0f3aeE31519670EcC62DC28f"
      }),
      createStrategy({
        strategy: "CRSV",
        symbol: "PLS-ETH",
        vaultAddress: "0xf9a3AAF97631080103Ec451E4d1e093ED7e7ca6b",
      ...
      createStrategy({
        strategy: "SSSV",
        symbol: "USDe-USDC",
        vaultAddress: "0xF8137C8CF3e049998dfD83C7B2FB680269e31b55",
